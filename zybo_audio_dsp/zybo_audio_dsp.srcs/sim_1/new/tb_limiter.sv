module tb_limiter ();
    ...
    wave_file_reader #(
        .AUDIO_SAMPLE_PATH ("/media/nisitha/My_Passport/MOODLE/Vivado_projects/Audio_processor_lab_repo/fpga_audio_processor-main/sim/common/snare.wav")
    ) wave_file_reader_inst (
        .i_clock           (clock),
    ...
    logic                  limiter_data_valid;
    logic [31:0]           limiter_data_left;
    logic [31:0]           limiter_data_right;
    limiter #(
        ...
        .i_linear_threshold(32'h4A989680),
        .o_data_valid      (limiter_data_valid),
        .o_data_left       (limiter_data_left),
        .o_data_right      (limiter_data_right)
    );
