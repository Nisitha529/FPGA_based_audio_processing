module wave_file_reader # (
    parameter string AUDIO_SAMPLE_PATH = "/media/nisitha/My_Passport/MOODLE/Vivado_projects/Audio_processor_lab_repo/fpga_audio_processor-main/sim/common/snare.wav"
) (
    input   logic           i_clock,
