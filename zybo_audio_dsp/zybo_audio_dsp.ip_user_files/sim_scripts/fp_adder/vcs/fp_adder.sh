...
#
# Script generated by Vivado on Sun Jul 13 23:33:33 +0530 2025
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fp_adder.sh
...
#
# Usage        : fp_adder.sh
#                fp_adder.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fp_adder.sh [-reset_run]
#                fp_adder.sh [-reset_log]
#                fp_adder.sh [-help]
#
...
#                script (type 'fp_adder.sh -help' for more information).
#
...
# script info
echo -e "fp_adder.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fp_adder.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fp_adder xil_defaultlib.glbl -o fp_adder_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fp_adder_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fp_adder_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fp_adder_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fp_adder.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fp_adder.sh [-help]\n\
Usage: fp_adder.sh [-step]\n\
Usage: fp_adder.sh [-lib_map_path]\n\
Usage: fp_adder.sh [-reset_run]\n\
Usage: fp_adder.sh [-reset_log]\n\
Usage: fp_adder.sh [-keep_index]\n\
Usage: fp_adder.sh [-noclean_files]\n\n\
