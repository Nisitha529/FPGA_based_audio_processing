...
#
# Script generated by Vivado on Sun Jul 13 23:06:56 +0530 2025
...
#
# Usage        : fixed_to_float.sh
#                fixed_to_float.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fixed_to_float.sh [-reset_run]
#                fixed_to_float.sh [-reset_log]
#                fixed_to_float.sh [-help]
#
...
#                script (type 'fixed_to_float.sh -help' for more information).
#
...
# script info
echo -e "fixed_to_float.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fixed_to_float.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fixed_to_float xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fixed_to_float -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fixed_to_float_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: fixed_to_float.sh [-step]\n\
Usage: fixed_to_float.sh [-lib_map_path]\n\
Usage: fixed_to_float.sh [-reset_run]\n\
Usage: fixed_to_float.sh [-reset_log]\n\
Usage: fixed_to_float.sh [-keep_index]\n\
