...
simulate()
{
  xsim fixed_to_float -key {Behavioral:sim_1:Functional:fixed_to_float} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_fir_filter_design.protoinst" -protoinst "protoinst_files/bd_fir_testing.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fixed_to_float.wdb xsim.dir libdpi.so)
