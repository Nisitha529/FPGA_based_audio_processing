...
#
# Script generated by Vivado on Sun Jul 13 18:50:04 +0530 2025
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dbfs_converter_0.sh
...
#
# Usage        : dbfs_converter_0.sh
#                dbfs_converter_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dbfs_converter_0.sh [-reset_run]
#                dbfs_converter_0.sh [-reset_log]
#                dbfs_converter_0.sh [-help]
#
...
#                script (type 'dbfs_converter_0.sh -help' for more information).
#
...
# script info
echo -e "dbfs_converter_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dbfs_converter_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.dbfs_converter_0 xil_defaultlib.glbl -o dbfs_converter_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./dbfs_converter_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key dbfs_converter_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc dbfs_converter_0_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dbfs_converter_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dbfs_converter_0.sh [-help]\n\
Usage: dbfs_converter_0.sh [-step]\n\
Usage: dbfs_converter_0.sh [-lib_map_path]\n\
Usage: dbfs_converter_0.sh [-reset_run]\n\
Usage: dbfs_converter_0.sh [-reset_log]\n\
Usage: dbfs_converter_0.sh [-keep_index]\n\
Usage: dbfs_converter_0.sh [-noclean_files]\n\n\
