...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dbfs_converter_0 xil_defaultlib.dbfs_converter_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dbfs_converter_0 -key {Behavioral:sim_1:Functional:dbfs_converter_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_fir_filter_design.protoinst" -protoinst "protoinst_files/bd_fir_testing.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dbfs_converter_0.wdb xsim.dir libdpi.so)
