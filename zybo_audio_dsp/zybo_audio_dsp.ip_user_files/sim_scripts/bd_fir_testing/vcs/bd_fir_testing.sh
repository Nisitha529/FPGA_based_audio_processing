...
design_libs=(xilinx_vip xpm xil_defaultlib xbip_utils_v3_0_11 axi_utils_v2_0_7 xbip_pipe_v3_0_7 xbip_bram18k_v3_0_7 mult_gen_v12_0_19 xbip_dsp48_wrapper_v3_0_5 xbip_dsp48_addsub_v3_0_7 xbip_dsp48_multadd_v3_0_7 dds_compiler_v6_0_23 lib_cdc_v1_0_2 proc_sys_reset_v5_0_14)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../zybo_audio_dsp.gen/sources_1/bd/bd_fir_testing/ipshared/c2c6" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../zybo_audio_dsp.gen/sources_1/bd/bd_fir_testing/ipshared/c2c6" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../zybo_audio_dsp.gen/sources_1/bd/bd_fir_testing/ipshared/c2c6" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bd_fir_testing xil_defaultlib.glbl -o bd_fir_testing_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bd_fir_testing_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key bd_fir_testing_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bd_fir_testing_simv.daidir vcs_lib c.obj)
