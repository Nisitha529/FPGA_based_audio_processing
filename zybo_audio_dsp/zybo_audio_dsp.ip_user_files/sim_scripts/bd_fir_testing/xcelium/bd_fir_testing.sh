...
#
# Script generated by Vivado on Sun Jul 13 13:03:43 +0530 2025
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bd_fir_testing.sh
...
#
# Usage        : bd_fir_testing.sh
#                bd_fir_testing.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bd_fir_testing.sh [-reset_run]
#                bd_fir_testing.sh [-reset_log]
#                bd_fir_testing.sh [-help]
#
...
#                script (type 'bd_fir_testing.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xil_defaultlib -libname xbip_utils_v3_0_11 -libname axi_utils_v2_0_7 -libname xbip_pipe_v3_0_7 -libname xbip_bram18k_v3_0_7 -libname mult_gen_v12_0_19 -libname xbip_dsp48_wrapper_v3_0_5 -libname xbip_dsp48_addsub_v3_0_7 -libname xbip_dsp48_multadd_v3_0_7 -libname dds_compiler_v6_0_23 -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_14 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xil_defaultlib xbip_utils_v3_0_11 axi_utils_v2_0_7 xbip_pipe_v3_0_7 xbip_bram18k_v3_0_7 mult_gen_v12_0_19 xbip_dsp48_wrapper_v3_0_5 xbip_dsp48_addsub_v3_0_7 xbip_dsp48_multadd_v3_0_7 dds_compiler_v6_0_23 lib_cdc_v1_0_2 proc_sys_reset_v5_0_14)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "bd_fir_testing.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bd_fir_testing.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../zybo_audio_dsp.gen/sources_1/bd/bd_fir_testing/ipshared/c2c6" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../zybo_audio_dsp.gen/sources_1/bd/bd_fir_testing/ipshared/c2c6" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../zybo_audio_dsp.gen/sources_1/bd/bd_fir_testing/ipshared/c2c6" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.bd_fir_testing xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.bd_fir_testing -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log bd_fir_testing_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bd_fir_testing.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bd_fir_testing.sh [-help]\n\
Usage: bd_fir_testing.sh [-step]\n\
Usage: bd_fir_testing.sh [-lib_map_path]\n\
Usage: bd_fir_testing.sh [-reset_run]\n\
Usage: bd_fir_testing.sh [-reset_log]\n\
Usage: bd_fir_testing.sh [-keep_index]\n\
Usage: bd_fir_testing.sh [-noclean_files]\n\n\
