...
design_libs=(xpm oddr_v1_0_3 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work oddr_v1_0_3 $vlogan_opts +v2k \
...
reset_run()
{
  files_to_remove=(ucli.key oddr_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc oddr_0_simv.daidir vcs_lib c.obj)
