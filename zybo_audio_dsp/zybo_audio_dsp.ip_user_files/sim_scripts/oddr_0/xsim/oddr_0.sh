...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L oddr_v1_0_3 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot oddr_0 xil_defaultlib.oddr_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim oddr_0 -key {Behavioral:sim_1:Functional:oddr_0} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_fir_filter_design.protoinst" -protoinst "protoinst_files/bd_fir_testing.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb oddr_0.wdb xsim.dir libdpi.so)
