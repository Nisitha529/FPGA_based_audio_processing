...
#
# Script generated by Vivado on Mon Jul 14 18:02:44 +0530 2025
...
#
# Usage        : oddr_0.sh
#                oddr_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                oddr_0.sh [-reset_run]
#                oddr_0.sh [-reset_log]
#                oddr_0.sh [-help]
#
...
#                script (type 'oddr_0.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname oddr_v1_0_3 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm oddr_v1_0_3 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "oddr_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./oddr_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work oddr_v1_0_3 $xmvlog_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.oddr_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.oddr_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log oddr_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: oddr_0.sh [-step]\n\
Usage: oddr_0.sh [-lib_map_path]\n\
Usage: oddr_0.sh [-reset_run]\n\
Usage: oddr_0.sh [-reset_log]\n\
Usage: oddr_0.sh [-keep_index]\n\
