...
#
# Script generated by Vivado on Mon Jul 14 13:55:27 +0530 2025
...
# script info
echo -e "float_to_fixed.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
simulate()
{
  xsim float_to_fixed -key {Behavioral:sim_1:Functional:float_to_fixed} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_fir_filter_design.protoinst" -protoinst "protoinst_files/bd_fir_testing.protoinst" -log simulate.log
}
