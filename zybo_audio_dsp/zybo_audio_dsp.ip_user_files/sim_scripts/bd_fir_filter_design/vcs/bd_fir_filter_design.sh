...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../zybo_audio_dsp.gen/sources_1/bd/bd_fir_filter_design/ipshared/c2c6" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../zybo_audio_dsp.gen/sources_1/bd/bd_fir_filter_design/ipshared/c2c6" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work blk_mem_gen_v8_4_7 $vlogan_opts +v2k +incdir+"../../../../zybo_audio_dsp.gen/sources_1/bd/bd_fir_filter_design/ipshared/c2c6" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../zybo_audio_dsp.gen/sources_1/bd/bd_fir_filter_design/ipshared/3c0c/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../zybo_audio_dsp.gen/sources_1/bd/bd_fir_filter_design/ipshared/c2c6" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xlconcat_v2_1_5 $vlogan_opts +v2k +incdir+"../../../../zybo_audio_dsp.gen/sources_1/bd/bd_fir_filter_design/ipshared/c2c6" +incdir+"/tools/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bd_fir_filter_design xil_defaultlib.glbl -o bd_fir_filter_design_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bd_fir_filter_design_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/media/nisitha/My_Passport/MOODLE/Vivado_projects/audio_zybo/zybo_audio_dsp/zybo_audio_dsp/zybo_audio_dsp.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key bd_fir_filter_design_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bd_fir_filter_design_simv.daidir vcs_lib c.obj)
