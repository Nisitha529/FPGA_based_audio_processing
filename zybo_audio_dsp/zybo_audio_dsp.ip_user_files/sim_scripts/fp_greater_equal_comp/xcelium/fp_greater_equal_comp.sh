...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fp_greater_equal_comp xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fp_greater_equal_comp -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fp_greater_equal_comp_sc.so .tmp_log xcelium_lib waves.shm c.obj)
