...
#
# Script generated by Vivado on Sun Jul 13 23:23:59 +0530 2025
...
#
# Usage        : fp_multiplier.sh
#                fp_multiplier.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fp_multiplier.sh [-reset_run]
#                fp_multiplier.sh [-reset_log]
#                fp_multiplier.sh [-help]
#
...
#                script (type 'fp_multiplier.sh -help' for more information).
#
...
# script info
echo -e "fp_multiplier.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fp_multiplier.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fp_multiplier xil_defaultlib.glbl -o fp_multiplier_simv
}
...
reset_run()
{
  files_to_remove=(ucli.key fp_multiplier_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fp_multiplier_simv.daidir vcs_lib c.obj)
...
Usage: fp_multiplier.sh [-step]\n\
Usage: fp_multiplier.sh [-lib_map_path]\n\
Usage: fp_multiplier.sh [-reset_run]\n\
Usage: fp_multiplier.sh [-reset_log]\n\
Usage: fp_multiplier.sh [-keep_index]\n\
