...
#                script (type 'delay_circular_buffer.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.delay_circular_buffer xil_defaultlib.glbl -o delay_circular_buffer_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./delay_circular_buffer_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key delay_circular_buffer_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc delay_circular_buffer_simv.daidir vcs_lib c.obj)
