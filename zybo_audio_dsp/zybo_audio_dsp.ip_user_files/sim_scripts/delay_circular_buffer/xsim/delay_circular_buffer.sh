...
#
# Script generated by Vivado on Sun Jul 13 23:33:14 +0530 2025
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : delay_circular_buffer.sh
...
#
# Usage        : delay_circular_buffer.sh
#                delay_circular_buffer.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                delay_circular_buffer.sh [-reset_run]
#                delay_circular_buffer.sh [-reset_log]
#                delay_circular_buffer.sh [-help]
#
...
# script info
echo -e "delay_circular_buffer.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./delay_circular_buffer.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot delay_circular_buffer xil_defaultlib.delay_circular_buffer xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim delay_circular_buffer -key {Behavioral:sim_1:Functional:delay_circular_buffer} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_fir_filter_design.protoinst" -protoinst "protoinst_files/bd_fir_testing.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb delay_circular_buffer.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./delay_circular_buffer.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: delay_circular_buffer.sh [-help]\n\
Usage: delay_circular_buffer.sh [-step]\n\
Usage: delay_circular_buffer.sh [-lib_map_path]\n\
Usage: delay_circular_buffer.sh [-reset_run]\n\
Usage: delay_circular_buffer.sh [-reset_log]\n\
Usage: delay_circular_buffer.sh [-keep_index]\n\
Usage: delay_circular_buffer.sh [-noclean_files]\n\n\
