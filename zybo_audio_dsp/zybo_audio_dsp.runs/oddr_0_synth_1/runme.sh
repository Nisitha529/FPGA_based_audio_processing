...
HD_PWD='/media/nisitha/My_Passport/MOODLE/Vivado_projects/audio_zybo/zybo_audio_dsp/zybo_audio_dsp/zybo_audio_dsp.runs/oddr_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log oddr_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source oddr_0.tcl
