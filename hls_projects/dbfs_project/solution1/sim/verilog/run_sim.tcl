...
if {[file isfile dbfs_converter.autotvin.dat]} {
	file delete -force dbfs_converter.autotvin.dat
}

if {[file isfile dbfs_converter.autotvout.dat]} {
	file delete -force dbfs_converter.autotvout.dat
}
