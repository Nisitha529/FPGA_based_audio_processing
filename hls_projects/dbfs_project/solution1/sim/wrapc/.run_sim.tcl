...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "dbfs_converter.autotvin.dat"
	set constFileTvOut       "dbfs_converter.autotvout.dat"
	set constFileHdlTvIn     "dbfs_converter.autohdltvin.dat"
	set constFileHdlTvOut    "dbfs_converter.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
