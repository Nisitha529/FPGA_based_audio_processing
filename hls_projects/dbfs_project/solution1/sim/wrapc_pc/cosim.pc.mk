...
$(ObjDir)/dbfs_converter_tb.cpp_pre.cpp.tb.o : dbfs_converter_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling dbfs_converter_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/dbfs_converter.cpp_pre.cpp.tb.o : dbfs_converter.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling dbfs_converter.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
